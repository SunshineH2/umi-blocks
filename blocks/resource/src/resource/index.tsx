...
export const typeList = [{ title: '菜单', value: 0 }, { title: '按钮', value: 1 }];
      ...
      render: (
        ...
        <div>
          ...
          <Button
            type="link"
            style={{ padding: '0' }}
            onClick={() => router.push({ pathname: `/resource/form`, query: { id: record.id } })}
          >
            编辑
          </Button>
          <Divider type="vertical" />
    ...
    <div className={styles.container}>
      <Table
        ...
        actions={[
          {
            text: '新增资源',
            onClick: () => router.push({ pathname: '/resource/form' }),
            type: 'primary',
          },
        ]}
      />
